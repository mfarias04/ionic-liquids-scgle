!factor de estructura de Hiroike, programa para calcular los parametros gamma por iteracion y el diagrama de arresto de una mezcla binaria de esferas cargadas
!
!
program kasuo_h
implicit none
...
open(unit = 1,file = 'skhiro.dat', status = 'unknown')
...
Ts=0.08
!write(*,*) "escribe la temperatura reducida"
!read(*,*) Ts
...
!	write(1,*) sngl(k), sngl(Q(1,1,nk)), sngl(Q(1,2,nk)),sngl(Q(2,2,nk))
